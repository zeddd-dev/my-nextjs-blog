  ...
  return (
    <footer className="border-t border-border/60 bg-card/50 backdrop-blur-xs mt-16">
      <div className="w-full py-12">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
          ...
          <div className="space-y-4 md:col-span-5">
            ...
            <p className="max-w-sm text-sm leading-relaxed text-muted-foreground">
              ...
              kabar terbaru seputar web development, gadget, AI, dan inovasi
              digital.
            </p>
          </div>
        ...
        {/* Copyright & Legal */}
        <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-border/40 pt-8 text-sm text-muted-foreground sm:flex-row">
